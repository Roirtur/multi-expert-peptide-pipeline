...
\author[N.F \& E.I \& A.M \& N.R]{Nathan Fitger \and Eduard Iliescu \and Arthur Macdonald \and Niels Roudeau}
...
% Logo Placeholder
\titlegraphic{
    \includegraphics[width=3cm]{ubordeaux.png}
}
...
\input{sections/03_chimiste}
\input{sections/04_biologiste}
\input{sections/05_architecture}
\input{sections/06_resultats}
\input{sections/07_limitations}
\input{sections/08_perspectives_avenir.tex}
