...
\begin{frame}
    ...
    \begin{block}{Modèle du générateur}
        \begin{itemize}
        \item Modèle fait main générant des séquences de peptides à partir de séquence ou propriétés souhaitées
...
\begin{frame}
    \begin{block}{Évaluation du générateur}
        \begin{itemize}
        \item Évaluation de la qualité des peptides générés en comparant leurs propriétés à celles des peptides connus [AJOUTER UNE COMPARAISON AVEC LA BDA PEPTIDES SITE ET UNE PEPTIDE GENEREE PAR LE CVAE]
